...
angular.module('managementConsole.api')
    ...
    function ($http, $q, modelController) {
         ...
         *
         */
        NodeCreateController.prototype.createServerNode = function (address, autoStart, group, socketBindingGroup, socketBindingPortOffset, callback) {
            var op = {
                'operation': 'add',
...
//# sourceMappingURL=node-creation-controller.service.js.map