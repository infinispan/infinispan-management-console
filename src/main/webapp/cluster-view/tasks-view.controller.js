...
angular.module('managementConsole')
    ...
    function ($scope, $stateParams, modelController, clusterNodesService, utils, $modal, $controller, taskService) {
        ...
        var CreateTaskModalController = function ($scope, $modalInstance, modelController, currentCluster) {
            ...
            angular.forEach(modelController.getServer().getNodes(), function (node) {
                if (node.isRunning()) {
            ...
            $scope.executeTask = function (server) {
                taskService.executeTask(currentCluster, server, $scope.selectedTask.name, $scope.selectedCache.name, $scope.asyncTask, $scope.params).then(function (response) {
...
//# sourceMappingURL=tasks-view.controller.js.map