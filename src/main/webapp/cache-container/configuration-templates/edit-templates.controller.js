...
angular.module('managementConsole')
    ...
    function ($scope, $state, $stateParams, utils, $modal, modelController, cacheCreateController, configurationTemplates, CONSTANTS) {
        ...
        $scope.removeTemplate = function (template) {
            cacheCreateController.removeCacheConfigurationNode($scope.currentCluster.getProfileName(), $scope.currentCluster.getName(), template.type, template.name).then(function () {
...
//# sourceMappingURL=edit-templates.controller.js.map