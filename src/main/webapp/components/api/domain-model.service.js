define(["require", "exports", "../../App"], function (require, exports, App_1) {
    "use strict";
    var module = App_1.App.module('managementConsole.api.domain-model', []);
    module.factory('DomainModel', [
        '$q',
        'ClusterModel',
        'ProfileModel',
        'ServerGroupModel',
        ...
        function ($q, ClusterModel, ProfileModel, ServerGroupModel, ServerModel) {
            ...
            Domain.prototype.getClusterByName = function (name) {
...
//# sourceMappingURL=domain-model.service.js.map