define(["require", "exports", "../../App"], function (require, exports, App_1) {
    "use strict";
    var module = App_1.App.module('managementConsole.api.cluster-model', []);
    module.factory('ClusterModel', [
        '$q',
        'CacheModel',
        'EndpointModel',
        'utils',
            ...
            Cluster.prototype.getEndpoints = function (clusterName) {
                ...
                var updateEndpoints = function (socketEndpoints, endpoint) {
                    if (endpoint['cache-container'] === clusterName) {
                        ...
                        socketEndpoints.push(new EndpointModel(bindingName, !fixedPort ? bindingPort + offset : bindingPort, utils.isNotNullOrUndefined(endpoint.encryption) ? endpoint.encryption : ''));
                    }
                };
...
//# sourceMappingURL=cluster-model.service.js.map