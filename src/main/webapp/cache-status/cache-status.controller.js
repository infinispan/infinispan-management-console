        ...
        $scope.setCacheRebalance = function (rebalance) {
            clusterNodesService.getCoordinator($scope.currentCluster).then(function (coord) {
                var resourcePathCacheContainer = coord.getResourcePath()
                    .concat('subsystem', 'datagrid-infinispan', 'cache-container', $scope.currentCluster.getName(), $scope.currentCache.type, $scope.currentCache.getName());
                var op = {
...
//# sourceMappingURL=cache-status.controller.js.map