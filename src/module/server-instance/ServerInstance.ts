  ...
  $stateProvider.state("server-instance", {
    ...
    resolve: {
      ...
      coord: ["$q", "$stateParams", "serverGroupService", "jGroupsService", "serverService",
        ($q: ng.IQService, $stateParams: IStateParamsService, serverGroupService: ServerGroupService,
      ...
      serverInstance: ["$stateParams", "serverService", ($stateParams: IStateParamsService, serverService: ServerService) => {
